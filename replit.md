...
- **CharacterRenderer** (`components/character/CharacterRenderer.tsx`): Premium flat illustration renderer — single self-contained file (no external layer imports). 120×360 SVG viewbox with 1:6.5 head-to-body ratio. 25 render layers in z-order: ground shadow, prestige aura (subtle/visible/legendary particles), shoes (casual/sneaker/formal/boot), legs+pants with creases, belt+buckle, torso/shirt, arms, collar, shirt details (placket/seams/hem), cuffs, neck, head, ears, hair back layer, face shadow, eyebrows (face-shape-aware), eyes (round/almond/wide), nose, mouth, hair front layer, chain/necklace+pendant, watch (basic/refined/elite with crown), ring+gem, eyewear (thin-frame/bold-frame/sunglasses), lapel pin+star. Size map: small(80×240), medium(140×420), large(180×540), full(240×720). Posture offsets shift head/torso Y. Female body uses narrower shoulders (68 vs 76). 12 hair styles ported to new head coordinates. memo() wrapped.
