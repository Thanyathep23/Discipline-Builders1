...
export const ITEM_SVG_MAP: Record<string, React.FC<VisualProps>> = {
  ...
  "apple-watch-ultra": StarterTimepieceSVG,
  "timex-expedition": MinerBlackSVG,
  "seiko-prospex": MinerBlackSVG,
  "chronograph-sport": ChronoSportSVG,
  "classic-dress-watch": RoyalSeriesSVG,
  "breitling-superocean-44": MinerBlackSVG,
  "rolex-datejust": GenevePerpetualSVG,
  "patek-philippe-calatrava": GenevePerpetualSVG,
  "richard-mille-rm011": CarbonRMSVG,
