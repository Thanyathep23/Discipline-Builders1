...
export default function AdminScreen() {
  ...
  const NAV_ITEMS = [
    ...
    { label: "Support Cases",       icon: "headset-outline" as const,        route: "/admin/support/cases",    color: Colors.cyan,    section: "Players" },
    ...
    { label: "Incidents",           icon: "warning-outline" as const,        route: "/admin/incidents",        color: Colors.crimson, section: "Ops" },
    { label: "Diagnostics",         icon: "hardware-chip-outline" as const,  route: "/admin/diagnostics",      color: Colors.accent,  section: "Ops" },
    { label: "Repair & Reconcile",  icon: "construct-outline" as const,      route: "/admin/repair",           color: Colors.amber,   section: "Ops" },
    { label: "Runbooks",            icon: "book-outline" as const,           route: "/admin/runbooks",         color: Colors.textSecondary, section: "Ops" },
    { label: "Experiments",         icon: "flask-outline" as const,          route: "/admin/experiments",      color: Colors.accentGlow, section: "Experiments" },
